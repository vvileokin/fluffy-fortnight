...
export default function MatchesAdmin() {
  ...
  async function save() {
    ...
    const payload = {
      ...
      // Blank rows are dropped rather than saved: an empty tournament name
      // renders as a gap in the history with a score floating beside it.
      h2h: {
        a: e.h2h_a,
        b: e.h2h_b,
